...
<html lang="en">
    <head>
        ...
        <meta name="Description" content="BCB Node Monitor is a server-side PHP-based monitor for Bitcoin Black nodes.">
        ...
        <link rel="icon" href="static/img/high-res.png">
        <meta property="og:title" content="<?php echo currencyName($currency); ?> Node Monitor - <?php echo $nanoNodeName; ?>">
        <meta property="og:description" content="BCB Node Monitor">
        <meta property="og:type" content="website">
        <meta property="og:image" content="static/img/high-res.png">
        <meta name="bcb" content="<?php echo $nanoDonationAccount; ?>">
    </head>
    <body>
    <script>
    var init = [];
